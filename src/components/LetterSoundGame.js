...
const API_URL = "http://127.0.0.1:5000/get_sounds";

const LetterSoundGame = () => {
        ...
        <ul className="sidebar-list">
          ...
          <li className="sidebar-item">
            <button
              ...
              onClick={() => navigate(`/assessment?learner_id=${learner_id}&username=${username}&difficulty_level=${difficulty_level}&session_id=${session_id}&module=${module}`)}
            >
              Assessment
            </button>
          </li>
